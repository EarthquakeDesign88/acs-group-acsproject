...
<head>
    ...
    <title>Upload Project Image</title>
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row">
                <div class="col-lg-12 mb-4 order-0">
                    <div class="row mb-2">
                        <div class="col-10">
                            <h3 class="card-title text-primary"><?= $lang['projects']['view_projects']['upload_project_image'] ?> 
                            <?php
                                if($_SESSION['lang'] == "th") { ?>
                                    <span class="badge bg-warning" style="font-size: 16px"><?= $projectNameTH ?></span> 
                            <?php   } else { ?>
                                    <span class="badge bg-warning" style="font-size: 16px"><?= $projectNameEN ?></span> 
                            <?php    }
                            ?>                   
                        ...
                        <div class="col-2">
                            <a href="./projects.php"><button type="button" class="btn btn-primary float-end"><?= $lang['projects']['view_projects']['btn']['back'] ?></button></a>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <form id="imageUploadForm" enctype="multipart/form-data">
                                ...
                                <div class="mt-2">
                                    <button type="submit" class="btn btn-primary me-2" id="upload"><?= $lang['projects']['view_projects']['btn']['upload'] ?></button>
