<?php 
    ...
    if(isset($_POST['project_id'])) {
        ...
        $content .= '  
                        ...
                        <div class="col-12">
                            <p class="text-title">
                                ' .$project_year_of_commencement. ' : <span><small class="text-main">' .number_format($project['project_year_of_commencement'], 0). '</small></span>
                            </p>
                        </div>
                        <div class="col-12">
                            <p class="text-title">
                                ' .$project_year_of_completion. ' : <span><small class="text-main">' .number_format($project['project_year_of_completion'], 0). '</small></span>
                            </p>
                        </div>';
