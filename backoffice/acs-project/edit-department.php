        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row">
                <div class="col-lg-12 mb-4 order-0">
                    <div class="row mb-2">
                        <div class="col-6">
                            <h3 class="card-title text-primary"><?= $lang['departments']['edit_department_header'] ?> <span id="load-data"></span></h3>
                        </div>
                        <div class="col-6">
                            ...
                            <form id="updateDepartmentForm">
                                <div class="row">
                                   <?php
                                        ...
                                        $departments = $departmentObj->getDepartmentById($department_id);

                                        foreach($departments as $department) { ?>
                                            <div class="mb-3 col-md-6">
                                                <label for="Department" class="form-label"><?= $lang['departments']['department_name'] ?></label>
                                                <input type="text" class="form-control" id="department_name" name="department_name" placeholder="<?= $lang['departments']['placeholder']['department_name'] ?>" value="<?= $department['department_name'] ?>" autocomplete="off"/>
                                            </div>
                                            <div class="mb-3 col-md-6"></div>
                                            <div class="mb-3 col-md-6">
                                                <label for="Description" class="form-label"><?= $lang['departments']['department_desc'] ?></label>
                                                <div class="input-group input-group-merge">
                                                    <input type="text" class="form-control" id="department_desc" name="department_desc" placeholder="<?= $lang['departments']['placeholder']['department_desc'] ?>" value="<?= $department['department_desc'] ?>" autocomplete="off"/>
                                                </div>
                                            </div>
    ...
    <script type="text/javascript">
        $('#updateDepartmentForm').on("submit", function(e) {
            ...
            if ($('#department_name').val() == '') {
                ...
                var updateDepartmentForm = $(this).serialize();
                
                $.ajax({
                    type: "POST",
                    url: "./Controllers/backEnd/DepartmentController/DepartmentController-update.php",
