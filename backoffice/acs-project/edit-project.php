        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row">
                <div class="col-lg-12 mb-4 order-0">
                    <div class="row mb-2">
                        <div class="col-6">
                            <h3 class="card-title text-primary"><?= $lang['projects']['view_projects']['edit_project_header'] ?> <span id="load-data"></span></h3>
                        </div>
                        <div class="col-6">
                            <button class="btn btn-primary float-end" onclick="history.back()"><?= $lang['projects']['view_projects']['btn']['back'] ?></button>
                        </div>
                    </div>
                            ...
                            <form id="updateProjectForm">
                                <div class="row">
                                    <?php
                                        ...
                                        <input type="text" class="form-control" id="project_name_th" name="project_name_th" placeholder="<?= $lang['projects']['view_projects']['placeholder']['project_name_th'] ?>" value="<?=$project['project_name_th']?>" autocomplete="off"/>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="ProjectNameEN" class="form-label"><?= $lang['projects']['view_projects']['project_name_en'] ?></label>
                                        <div class="input-group input-group-merge">
                                            <input type="text" class="form-control" id="project_name_en" name="project_name_en" placeholder="<?= $lang['projects']['view_projects']['placeholder']['project_name_en'] ?>" value="<?=$project['project_name_en']?>" autocomplete="off"/>
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <select id="project_category" name="project_category" class="select2 form-select">
                                            ...
                                            <?php
                                                ...
                                                foreach ($categories as $category) { ?>
                                                    <option value="<?= $category['pcategory_id'] ?>"
                                                        <?php echo $category['pcategory_id'] == $project['project_category'] ? 'selected' : '' ?>
                                                    >
                                                        <?php
                                                            if($_SESSION['lang'] == "th") { ?>
                                                                <?= $category['pcategory_name_th'] ?>
                                                        <?php   }
                                                            else { ?>
                                                                <?= $category['pcategory_name_en'] ?>
                                                        <?php   }       
                                                        ?>
                                                    </option>
                                                <?php }
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control search_owner_name " placeholder="<?= $lang['projects']['view_projects']['placeholder']['select_project_owner'] ?>" value="<?=$project['owner_name_th']?>" autocomplete="off" id="project_owner">
                                        <input type="hidden" class="form-control search_owner_id" name="project_owner"  value="<?=$project['project_owner']?>">
                                            ...
                                            <?php
                                                ...
                                                foreach ($scopes as $scope) { ?>
                                                    <option value="<?= $scope['scope_id'] ?>"
                                                        <?php echo $scope['scope_id'] == $project['project_scope'] ? 'selected' : '' ?>
                                                    >
                                                        <?php
                                                            if($_SESSION['lang'] == "th") { ?>
                                                                <?= $scope['scope_name_th'] ?>
                                            ...
                                            <?php
                                                ...
                                                foreach ($types as $type) { ?>
                                                    <option value="<?= $type['type_id'] ?>"
                                                        <?php echo $type['type_id'] == $project['project_type'] ? 'selected' : '' ?>
                                                    >
                                                        <?php
                                                            if($_SESSION['lang'] == "th") { ?>
                                                                <?= $type['type_name_th'] ?>
                                            ...
                                            <?php
                                                ...
                                                foreach ($departments as $department) { ?>
                                                    <option value="<?= $department['department_id'] ?>"
                                                        <?php echo $department['department_id'] == $project['project_department'] ? 'selected' : '' ?>
                                                    >
                                            ...
                                            <?php
                                                ...
                                                foreach ($statuss as $status) { ?>
                                                    <option value="<?= $status['status_id'] ?>"
                                                        <?php echo $status['status_id'] == $project['project_status'] ? 'selected' : '' ?>
                                                    >
                                                        <?php
                                                            if($_SESSION['lang'] == "th") { ?>
                                                                <?= $status['status_name_th'] ?>     
                                                        <?php   }
                                                            else { ?>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="project_value" name="project_value" placeholder="<?= $lang['projects']['view_projects']['placeholder']['project_value'] ?>" value="<?=$project['project_value']?>" autocomplete="off"/>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="ProjectArea" class="form-label"><?= $lang['projects']['view_projects']['project_area'] ?></label>
                                        <div class="input-group input-group-merge">
                                            <input type="text" class="form-control" id="project_area" name="project_area" placeholder="<?= $lang['projects']['view_projects']['placeholder']['project_area'] ?>" value="<?=$project['project_area']?>" autocomplete="off"/>
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="ProjectLocationTH" class="form-label"><?= $lang['projects']['view_projects']['project_location_th'] ?></label>
                                        <div class="input-group input-group-merge">
                                            <textarea class="form-control" aria-label="With textarea" id="project_location_th" name="project_location_th" placeholder="<?= $lang['projects']['view_projects']['placeholder']['project_location_th'] ?>" autocomplete="off"><?=$project['project_location_th']?></textarea>
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="ProjectLocationEN" class="form-label"><?= $lang['projects']['view_projects']['project_location_en'] ?></label>
                                        <div class="input-group input-group-merge">
                                            <textarea class="form-control" aria-label="With textarea" id="project_location_en" name="project_location_en" placeholder="<?= $lang['projects']['view_projects']['placeholder']['project_location_en'] ?>" autocomplete="off"><?=$project['project_location_en']?></textarea>
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="ProjectDescriptionTH" class="form-label"><?= $lang['projects']['view_projects']['project_description_th'] ?></label>
                                        <div class="input-group input-group-merge">
                                            <textarea class="form-control" aria-label="With textarea" id="project_description_th" name="project_description_th" placeholder="<?= $lang['projects']['view_projects']['placeholder']['project_description_th'] ?>" autocomplete="off"><?=$project['project_description_th']?></textarea>
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="ProjectDescriptionEN" class="form-label"><?= $lang['projects']['view_projects']['project_description_en'] ?></label>
                                        <div class="input-group input-group-merge">
                                            <textarea class="form-control" aria-label="With textarea" id="project_description_en" name="project_description_en" placeholder="<?= $lang['projects']['view_projects']['placeholder']['project_description_en'] ?>" autocomplete="off"><?=$project['project_description_en']?></textarea>
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="ProjectYearOfCommencement" class="form-label"><?= $lang['projects']['view_projects']['project_year_of_commencement'] ?></label>
                                        <input type="text" class="form-control" id="project_year_of_commencement" name="project_year_of_commencement" placeholder="<?= $lang['projects']['view_projects']['placeholder']['project_year_of_commencement'] ?>" value="<?=$project['project_year_of_commencement']?>" autocomplete="off"/>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="ProjectYearOfCompletion" class="form-label"><?= $lang['projects']['view_projects']['project_year_of_completion'] ?></label>
                                        <div class="input-group input-group-merge">
                                            <input type="text" class="form-control" id="project_year_of_completion" name="project_year_of_completion" placeholder="<?= $lang['projects']['view_projects']['placeholder']['project_year_of_completion'] ?>" value="<?=$project['project_year_of_completion']?>" autocomplete="off"/>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
        ...
        $('#updateProjectForm').on("submit", function(e) {
            ...
            if ($('#project_name_th').val() == '') {
                ...
                var updateProjectForm = $(this).serialize();
                var userRole = '<?=$_SESSION['user_role']?>';

                $.ajax({
                    type: "POST",
                    url: "./Controllers/backEnd/ProjectController/ProjectController-update.php",
                    ...
                    success: function(response) {
                        if (response.status == 'success') {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    window.location = "edit-project.php";
                                }
                            })
                        }
                    }
