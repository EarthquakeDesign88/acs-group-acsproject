        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row">
                <div class="col-lg-12 mb-4 order-0">
                    <div class="row mb-2">
                        <div class="col-6">
                            <h3 class="card-title text-primary"><?= $lang['categories']['create_category_header'] ?> <span id="load-data"></span></h3>
                        </div>
                        <div class="col-6">
                            ...
                            <form id="createCategoryForm">
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="pcategory_name_th" name="pcategory_name_th" placeholder="<?= $lang['categories']['placeholder']['category_name_th'] ?>" autocomplete="off"/>
                                    </div>
                                    <div class="mb-3 col-md-6"></div>
                                    <div class="mb-3 col-md-6">
                                        <label for="CategoryNameEN" class="form-label"><?= $lang['categories']['category_name_en'] ?></label>
                                        <div class="input-group input-group-merge">
                                            <input type="text" class="form-control" id="pcategory_name_en" name="pcategory_name_en" placeholder="<?= $lang['categories']['placeholder']['category_name_en'] ?>" autocomplete="off"/>
                                        </div>
                                    </div>
                                ...
                                <div class="mt-2">
                                    ...
                                    <button type="reset" class="btn btn-outline-secondary"><?= $lang['categories']['btn']['reset'] ?></button>
                                </div>
                            </form>
                        </div>
                        <!-- /Account -->
    ...
    <script type="text/javascript">
        $('#createCategoryForm').on("submit", function(e) {
            ...
            if ($('#pcategory_name_th').val() == '') {
                ...
                var createCategoryForm = $(this).serialize();

                $.ajax({
                    type: "POST",
                    url: "./Controllers/backEnd/CategoryController/CategoryController-insert.php",
